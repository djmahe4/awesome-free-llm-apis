/**
 * @file verify-header-extraction.ts
 * @description Verifies that custom headers (rate limits, etc.) are correctly extracted from provider responses.
 * Usage: tsx scripts/verification/verify-header-extraction.ts
 */
