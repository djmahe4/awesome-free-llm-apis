/**
 * @file test-workspace-flow.ts
 * @description Verifies the end-to-end workspace scanning and structural context injection flow.
 * Usage: tsx scripts/verification/test-workspace-flow.ts
 */
