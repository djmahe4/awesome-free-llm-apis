...
/**
 * @file evaluate-routing.ts
 * @description Benchmarks the IntelligentRouterMiddleware by running a series of queries and verifying the selected provider and model.
 * Usage: tsx scripts/evaluation/evaluate-routing.ts
 */
