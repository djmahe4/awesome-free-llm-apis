/**
 * @file demo-live-tasks.ts
 * @description Demonstrates live task execution with agentic memory and tool-calling capabilities.
 * Usage: tsx scripts/verification/demo-live-tasks.ts
 */
import { 
    PipelineExecutor, 
