    ...
    tools: [
      {
        ...
        description: [
          ...
          'In the prompt use keywords like "summarize", "code", "search", "classify", "extract" to help the router choose the best model.',
          '',
          'INPUTS:',
          '  model (optional)      — Model ID, e.g. "llama-3.3-70b-versatile" or "gemini-2.0-flash".',
