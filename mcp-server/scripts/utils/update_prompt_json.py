"""
file: update_prompt_json.py
description: Synchronizes the intelligent system prompt by extracting sections from README.md and generating prompt.json.
Usage: python scripts/utils/update_prompt_json.py
"""
import json
import os
import re
