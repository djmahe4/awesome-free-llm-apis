/**
 * @file verify-context-pressure.ts
 * @description Verifies model behavior and router stability under heavy context pressure (large message history).
 * Usage: tsx scripts/verification/verify-context-pressure.ts
 */
